...
//==============================================================================
#define TwoRconPass "sean" //Define the Second RCON Password
//==============================================================================
// -> Account Commands
...
dcmd_ahelp(playerid,params[])
{
	...
	{
		SendClientMessage(playerid, white, "___________ |- Mahony's Admin System - Help -| ___________");
...
dcmd_observations(playerid,params[])
{
	...
	if(AccInfo[playerid][Level] > 0)
	{
		SendClientMessage(playerid, white, "___________ |- Mahony's Admin System - Observations -| ___________");
...
dcmd_level(playerid,params[])
{
    if(AccInfo[playerid][Level] >= 1)
	{
		...
		if(AccInfo[playerid][Level] >= 1)
		{
		SendClientMessage(playerid, white, "___________ |- Mahony's Admin - Trial Moderator (Level 1) -| ___________");
		...
		{
		SendClientMessage(playerid, white, "___________ |- Mahony's Admin - Moderator (Level 2) -| ___________");
		...
		if(AccInfo[playerid][Level] >= 3)
		{
		SendClientMessage(playerid, white, "___________ |- Mahony's Admin - Administrator (Level 3) -| ___________");
		...
		if(AccInfo[playerid][Level] >= 4)
		{
        SendClientMessage(playerid, white, "___________ |- Mahony's Admin - Lead Administrator (Level 4) -| ___________");
		...
		if(AccInfo[playerid][Level] >= 5)
		{
		SendClientMessage(playerid, white, "___________ |- Mahony's Admin - Server Owner (Level 5) -| ___________");
...
dcmd_lconfig(playerid,params[])
{
	...
	if(AccInfo[playerid][Level] > 0)
	{
		...
		SendClientMessage(playerid, LIGHTBLUE, "___________ |- Mahony's Admin System - Configuration -| ___________");
